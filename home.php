...
<button class="btn btn-primary" type="button" id="post1" onclick='set_pref();'>Submit</button>
...
<button type="button" value="Post" class="btn btn-primary" onclick='new_posts();'/>Post</button>
<button class="btn btn-default" type="submit" id="post" >Cancel</button>
</form>
<br>

<br>
<table ><tr><td style='width:100%; border-radius:10px;'>  <p  id='posts' style='padding:10px'></p></td></tr>
<tr><td style='width:100%; border-radius:10px;'>  <p  id='new_posts' style='padding:10px'></p></td></tr>
</table>
