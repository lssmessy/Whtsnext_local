...
{
	$required=array('username','password','password_again','firstname','email','birthday','city','country','skills','profession');
...
{
	echo "You've been successfully registered.Please check your email to activate!</br>";
	echo "[Note]: Please check your '<strong>[SPAM/JUNK]</strong>' folder if mail doesn't came in your Inbox!!";
}
else{
if(empty($_POST)==false && empty($errors)==true)
{	
	if($_POST['gender']=='male'){	$file_path='images/male.png';}
	else {	$file_path='images/female.png';}
...
<div class="form-group"><label for="re_pwd">Re-type Password:*</label>
...
<input type="radio" name="gender" value="male" checked> Male <input type="radio" name="gender" value="female">Female </div>
<div class="form-group"><label for="bday">Birthday *: (dd-mm-yyyy)</label>
<input type="text" name="birthday" id="datepicker" class="form-control"></div>
...
<input type="text" name="skills" class="form-control" ></div>
<div class="form-group"><label for="prof">Profession *:</label>
<select class="form-control" id="sel1" name="profession" class="form-control" >
		...
		<option value='B.E(Bachelor of Engineering) Graduate' selected>B.E(Bachelor of Engineering) Graduate</option>
